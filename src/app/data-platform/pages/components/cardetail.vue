<template>
  <div class="flex flex-col flex-1 cardetail">
    <div class="flex justify-between cardetail_header">
    ...
    <div class="flex justify-end cardetail_edit">
    ...
    <div class="cardetail_content">
      <div class="flex flex-row items-stretch flex-1 ml-body h-[100%]">
        <div class="cardetail_content_left flex-none w-[390px] flex flex-col">
          <div class="flex cardetail_content_left_item">
